...
public class fragment_frame extends Fragment {
    ...
    private FragmentFrameViewModel mViewModel;

    public static fragment_frame newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(FragmentFrameViewModel.class);
